...
const Footer = () => {
  return (
    <div className="absolute w-full bottom-auto bg-[#f9f9f9] left-0 mt-16 font-light">
      <div className="max-w-7xl  px-4 mx-auto xl:py-8 mb-20 text-[#848484]">
        <div className="flex flex-col-reverse md:flex-row justify-between">
          ...
          <div className="text-lg">
            ...
            This site was designed in&nbsp;
              <a href="https://www.figma.com/" className="text-sky-500" target="_blank" rel="noreferrer">Figma</a>,&nbsp;
        
              <a href="https://tailwindcss.com/" className="text-sky-500" target="_blank" rel="noreferrer">tailwindcss&nbsp;</a> 
        
                with a cup of&nbsp;
        
              <a href="https://react.dev/" className="text-sky-500" target="_blank" rel="noreferrer">react&nbsp;</a>
        
                &amp;&nbsp;
        
              <a href="https://www.netlify.com/" className="text-sky-500" target="_blank" rel="noreferrer">deployed via Netlify</a>.
            </p>
          </div>
